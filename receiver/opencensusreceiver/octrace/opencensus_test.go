	...
	wantSpans := []*tracepb.Span{
		{
			...
			StartTime:    ptime.TimeToTimestamp(serverSpanData.StartTime),
			EndTime:      ptime.TimeToTimestamp(serverSpanData.EndTime),
		...
		},
		{
			...
			StartTime:    ptime.TimeToTimestamp(clientSpanData.StartTime),
			EndTime:      ptime.TimeToTimestamp(clientSpanData.EndTime),
